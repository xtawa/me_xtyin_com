...
export const Navbar: React.FC<NavbarProps> = ({ onNavigate }) => {
  ...
  return (
    <header className="fixed top-0 w-full z-50 px-6 py-6 md:px-8 md:py-8 flex justify-center bg-gradient-to-b from-[#050505] to-transparent pointer-events-none">
      <div className="w-full max-w-screen-xl flex justify-between items-center pointer-events-auto">
        {/* Logo Area */}
        <div>
          <a 
            href="#" 
        ...
        {/* Navigation Links */}
        <nav className="flex items-center gap-5 md:gap-6 text-sm font-medium">
